<template> 
    <footer class="bg">
        <div class="text-gray-500 order-3 md:w-auto md:order-2 nav-links-container">
        ...
        <div class="mx-auto w-full max-w-screen-xl mt-3">
            ...
            <div class="px-4 py-6 bg-gray-100 dark:bg-gray-700 md:flex md:items-center md:justify-between">
                ...
                <div class="flex mt-4 sm:justify-center md:mt-0 space-x-5 rtl:space-x-reverse">
                    ...
                    <a href="https://github.com/Yassir-MMI" class="text-gray-400 hover:text-gray-900 dark:hover:text-white">
