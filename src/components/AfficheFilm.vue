            ...
            <div class="grid rounded-3xl max-w-[370px] shadow-sm bg-slate-100  flex-col">
                ...
                <div class=" grid-cols-2 flex group justify-between">
                    <div class="font-black flex flex-col">
                        <span class="text-yellow-500 text-xl">YASS SCORE</span>
                ...
                <div class="flex flex-col items-end">
                    <span class="text-yellow-500 text-xl">DIRECTOR</span>
                    <span class="text-3xl group-hover:text-yellow-600">Joachim Rønning</span>
                </div>
            </div>
            </div>
        </div>
